...
a = Analysis(
    ...
    datas=[
        ...
        ('C:/Users/52953/.conda/envs/x-anylabeling-gpu/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_cuda.dll', 'onnxruntime/capi'),
        ('C:/Users/52953/.conda/envs/x-anylabeling-gpu/Lib/site-packages/onnxruntime/capi/onnxruntime_providers_shared.dll', 'onnxruntime/capi'),
        ('YOLO_UI', 'YOLO_UI'),
    ],
    hiddenimports=[],
    hookspath=[],
